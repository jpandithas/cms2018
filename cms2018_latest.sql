...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 07, 2018 at 10:24 AM
...
(9, 'another page', 'Content goes here', 'another', '2018-04-18 16:04:04', '2018-04-18 16:04:04');
...
INSERT INTO `routes` (`routeid`, `action`, `type`, `id`, `mod_name`, `mod_real_name`, `mod_desc`, `status`, `tier`) VALUES
(1, 'add', 'page', 0, 'add_page', 'Add Page', 'This is the add page module', 1, 2),
(2, 'login', NULL, 0, 'login', 'Login', 'This is the login module ', 1, 4),
